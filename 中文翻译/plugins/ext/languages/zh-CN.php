...
define('TEXT_EXT_CHANGE_HISTORY_REPORT_ENTITIES_INFO','添加需要跟踪更改记录的实体。<br>请注意：仅当用户有权查看指定实体的所有记录时才会显示报表数据。');
define('TEXT_EXT_TRACK_FIELDS_INFO','默认跟踪所有字段的更改记录。');
...
define('TEXT_EXT_PROCESSES_DISABLE_COMMENTS_TIP','默认评论中会包含字段更改历史。');
